...
export default function Footer() {
    return (
        <div className="bg-zinc-800 text-white rounded-3xl pt-10">
            <div className="h-64 grid grid-cols-3 md:grid-flow-col">
                ...
                <div>
                    ...
                    <hr className="w-1/6 mb-8 border-red-600 border-1"></hr>
                ...
                <div>
                    ...
                    <ul className=" text-zinc-300">
                        ...
                        <li className="my-1">
                            <div className="flex">
                                <span>
                                    <svg className="h-6 w-6" viewBox="0 0 24 24" stroke="currentColor" fill="none">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
